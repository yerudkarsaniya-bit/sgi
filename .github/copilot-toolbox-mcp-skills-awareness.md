...
_Generated: 2026-03-30T10:34:11.468Z_
...
Workspace `mcp.json` _(folder: sgi)_

- **d:\git1\sgi\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Student\AppData\Roaming\Code\User\mcp.json** — _File missing_
